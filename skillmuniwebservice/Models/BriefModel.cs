...
namespace m2ostnextservice.Models
{
    ...
    public class BriefModel
    {
        ...
        public List<BriefAPIResource> getBriefListWithAcademy(string sql, int UID)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    double? briefLogResult = reader["briefLogResult"] == DBNull.Value ? (double?)null : Convert.ToDouble(reader["briefLogResult"]);
                    ...
                    temp.bookmarked = Convert.ToInt32(string.IsNullOrEmpty(reader["bookmarked"]?.ToString()) ? 0 : reader["bookmarked"]);
        ...
        public BriefResource getBriefDataAssment(string brf, int UID, int OID)
        {
            List<APIBrief> list = new List<APIBrief>();
            BriefResource bBody = new BriefResource();
