...
namespace m2ostnextservice.Models
{
    ...
    public class preferencemodelrequest
    {
        public int id_user { get; set; }
        public List<int> id_industry{ get; set; }
        public List<int> id_category { get; set; }
        public List<int> id_job_role { get; set; }
        public List<int> id_job_type { get; set; }
        public List<int> id_city { get; set; }
        public int experience_years { get; set; }
        public int experience_months { get; set; }       
    ...
    public class preferencemodel
    {
        ...
        public List<int> id_job_role { get; set; }
        public List<int> id_job_type { get; set; }
        public List<int> id_country { get; set; }
        public List<int> id_state { get; set; }
        public List<int> id_city { get; set; }
        public int experience_years { get; set; }
        public int experience_months { get; set; }
        public string skills { get; set; }
